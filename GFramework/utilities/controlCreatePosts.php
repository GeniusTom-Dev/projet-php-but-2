...
class controlCreatePosts
{
    ...
    function getCreatePost(): string
    {
        ...
        <article
                class="postCreationInterface w-full md:w-1/2 lg:w-1/3 xl:w-1/2 h-auto md:h-1/3 lg:h-auto xl:h-auto bg-gray-100 rounded-lg shadow-md p-6">
            <form method="post" action="" class="postPublisher">
                ...
                <main class="max-h-60 overflow-y-auto">
                    <div class="flex flex-lign items-center mb-2">
                        <input type="text" name="title" placeholder="Titre du post"
                               class="title-input border border-[#b2a5ff] rounded-md font-bold text-xl">
                    ...
                    <textarea name="content" placeholder="Écrivez votre contenu ici"
                              class="content-input w-full break-words p-2 border border-[#b2a5ff] rounded-md"></textarea>
                    ...
                    <table class="w-full">
                        <tr>
                            <td>
                                ...
                                <button type="button"
                                        class="add-category-button bg-[#b2a5ff] text-white rounded-md px-2 py-1 m-2">
                                    Ajouter Catégorie
                                </button>
                            </td>
                ...
                <footer>
                    <img id="paperPlane" src="/html/images/paper-plane-solid.svg" alt="paperPlane"
                         class="paperPlane w-4 h-auto transition-transform duration-300 hover:scale-125 ml-auto"
                         onclick="submit()">
                </footer>
                <div class="deleteConfirmation fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-4 border border-[#b2a5ff] rounded-lg shadow-md"
                    ...
                    <button class="confirmDeleteButton px-4 py-2 bg-red-500 text-white rounded-md ml-2">Confirmer
                    </button>
