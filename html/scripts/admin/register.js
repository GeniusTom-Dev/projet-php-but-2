...
registerInput.addEventListener("input", () => {
    ...
    // console.log("Complexité du mot de passe :", passwordStrength.score); // Le score est une valeur de 0 à 4, 0 étant faible et 4 étant fort
    // console.log("Suggestion pour améliorer le mot de passe :", passwordStrength.feedback.suggestions);
})