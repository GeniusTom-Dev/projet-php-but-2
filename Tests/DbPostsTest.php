...
class DbPostsTest extends TestCase
{
    ...
    public function test_select_by_like_date() {
        $result = $this->getConnection()->convertSQLResultToAssocArray($this->getConnection()->select_SQLResult(null, null, '2023-10-01', '2023-10-06'))->getContent();
        $this->assertCount(3, $result);
    }

    public function test_select_by_like_date_2() {
        $result = $this->getConnection()->convertSQLResultToAssocArray($this->getConnection()->select_SQLResult(null, null, '2021-10-01', '2022-10-06'))->getContent();
        $this->assertCount(0, $result);
    }

    public function test_select_many_filter() {
        $result = $this->getConnection()->convertSQLResultToAssocArray($this->getConnection()->select_SQLResult("rand", 2, '2023-09-28', '2023-10-06'))->getContent();
    ...
    public function test_add() {
        ...
        $checkIfWasAdd = $this->getConnection()->convertSQLResultToAssocArray($this->getConnection()->select_SQLResult("un Titre", 3, "2023-10-06", "2023-10-06"))->getContent();
    ...
    public function test_update_title_and_content() {
        ...
        $checkIfWasUpdated = $this->getConnection()->convertSQLResultToAssocArray($this->getConnection()->select_SQLResult("un Nouveau Titre", 3, "2023-10-06", "2023-10-06"))->getContent();
    ...
    public function test_delete() {
        ...
        $checkIfWasDelete = $this->getConnection()->convertSQLResultToAssocArray($this->getConnection()->select_SQLResult("un Nouveau Titre", 3, "2023-10-06", "2023-10-06"))->getContent();
